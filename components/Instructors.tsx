      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <h2 className="text-2xl md:text-3xl font-bold text-white drop-shadow-md relative inline-block">
            あなたの英語学習をサポートする<br className="md:hidden"/>素敵な講師たち
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-8">
          {INSTRUCTORS.map((instructor) => (
            <div key={instructor.id} className="bg-white rounded-2xl shadow-xl overflow-hidden hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2">
              <div className="p-6 flex flex-col items-center">
                ...
                <div className="w-full space-y-3 mt-4 text-sm">
                  <div className="flex items-start gap-2">
                    ...
                    <p className="text-gray-600">{instructor.background}</p>
                  </div>
                  <div className="flex items-start gap-2">
                    <Heart className="w-4 h-4 text-pink-400 mt-1 shrink-0" />
                    <p className="text-gray-600">{instructor.hobbies}</p>
                  </div>
                  <div className="flex items-start gap-2">
