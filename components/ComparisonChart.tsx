...
const data = [
  ...
  { name: 'デート留学', value: 90, color: '#f43f5e' }, // Rose-500
];
      ...
      <div className="max-w-5xl mx-auto px-4 flex flex-col md:flex-row items-center gap-12">
        <div className="md:w-1/2">
          <h2 className="text-3xl md:text-4xl font-bold text-gray-800 mb-6">
            <span className="text-pink-500">発話量</span>が違います。
          </h2>
          <p className="text-gray-600 text-lg leading-relaxed mb-6">
            教室で他の生徒の話を聞いているだけの時間、もったいなくないですか？<br/>
            デート留学なら、常に先生とマンツーマン。移動中も、食事中も、すべてがレッスンの場です。
          </p>
        ...
        <div className="w-full md:w-1/2 h-80 bg-white p-6 rounded-3xl shadow-lg border border-gray-100">
